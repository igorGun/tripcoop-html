...
var map = new google.maps.Map(document.getElementById('map'), {
    zoom: 13,
    center: {lat: 49.992157, lng: 36.231082}
});
...
var myLatLng = [{lat: 49.992157, lng: 36.231082}];
        ...
        '<form class="info-window__form" id="set-trip-form" action="/set" method="post">' +
          ...
          '<div class="form-group">' +
            '<div class="info-window__form-buttons">' +
              ...
              '<button type="submit" id="set-trip-button" class="btn btn-success">Создать поездку</button>' +
            '</div>' +
          '</div>' +
        '</form>' +
      '</div>' +
